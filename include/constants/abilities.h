...
enum __attribute__((packed)) Ability
{
    ...
    ABILITY_BOOM_BOX = 319,
	ABILITY_SHELLEMENTAL = 320,
	ABILITY_ALL_TERRAIN = 321,
	ABILITY_MESOGLACIES = 322,
	ABILITY_CENOSOLARIS = 323,
	ABILITY_ZONAI_DRIVE = 324,
	ABILITY_AMIHAN = 325,
	ABILITY_HABAGAT = 326,
	ABILITY_RAMUH = 327,
	ABILITY_AIR_PRESSURE = 328,
	ABILITY_TRI_OS = 329,
	ABILITY_SUN_SOAK = 330,
